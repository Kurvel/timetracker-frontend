...
interface LoginFormProps {
  onLogin?: (e: FormEvent<HTMLFormElement>, username: string, password: string) => void;
  onRegister?: (event: FormEvent<HTMLFormElement>, firstName: string, lastName: string, username: string, password: string, tasks: any[]) => void;
}
...
export default class LoginForm extends React.Component<LoginFormProps, State> {
  ...
  onSubmitRegister = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (onRegister) {
      ...
      onRegister(e, this.state.firstName, this.state.lastName, this.state.login, this.state.password, tasks);
    }
  }
